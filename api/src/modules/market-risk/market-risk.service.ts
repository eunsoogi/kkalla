...
import {
  ...
  createMarketRiskAllocationRecommendationRequestConfig,
...
export class MarketRiskService implements OnModuleInit {
  ...
  public async allocationRecommendation(items: RecommendationItem[]): Promise<AllocationRecommendationData[]> {
    ...
    const recommendationResults = await inferAndPersistSharedRealtimeRecommendation({
      ...
      logger: this.logger,
      i18n: this.i18n,
      responseLabel: 'market-risk recommendation',
      tradeOrchestrationService: this.tradeOrchestrationService,
      prompt: ALLOCATION_RECOMMENDATION_PROMPT,
      createRequestConfig: createMarketRiskAllocationRecommendationRequestConfig,
      ...
      minRecommendWeight: this.tradeOrchestrationService.getMinimumRecommendWeight(),
