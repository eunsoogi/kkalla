...
describe('HoldingsService', () => {
  const holdingLedgerService = {
    fetchHoldingsByUser: jest.fn(),
  };
  const upbitService = {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    service = new HoldingsService(holdingLedgerService as any, upbitService as any, categoryService as any);
  });
