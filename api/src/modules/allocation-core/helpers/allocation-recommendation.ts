 ...
 */
const normalizePercentToRate = (value: number): number => {
...
export function normalizeAllocationRecommendationResponsePayload(
  ...
  return {
    ...
    expectedVolatilityPct: Number.isFinite(expectedVolatilityPct) ? normalizePercentToRate(expectedVolatilityPct) : 0,
