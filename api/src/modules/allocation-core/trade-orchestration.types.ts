...
export interface TradePolicyConfig {
  ...
  defaultGrossExposureTarget: number;
  ...
  breakoutEntryMinConfidence: number;
  breakoutEntryMaxConcurrentEntries: number;
  breakoutEntryMaxEntriesPerCategory: number;
  profitabilityAuditTargetHitRate: number;
  profitabilityAuditTargetHitRateLift: number;
  profitabilityReplayWindowDays: number;
  profitabilityAuditPreferredHorizons: readonly number[];
  calibrationLowCostActiveExecutionNotionalMultiplier: number;
  calibrationMediumCostActiveExecutionNotionalMultiplier: number;
  calibrationElevatedCostActiveExecutionNotionalMultiplier: number;
