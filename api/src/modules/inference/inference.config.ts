...
export const INFERENCE_RULES = [
  ...
  'CVD 지표 및 파이어차트는 제시된 이미지 링크를 반드시 분석할 것',
  'reason은 반드시 캔들 차트, 뉴스, 공포탐욕지수, 기술적 지표를 어떻게 분석했는지 서술할 것',
  '현금 보유 비중이 0~0.2인 경우에 대해 1번 판단할 것',
  '현금 보유 비중이 0.2~0.4인 경우에 대해 1번 판단할 것',
  '현금 보유 비중이 0.4~0.6인 경우에 대해 1번 판단할 것',
  '현금 보유 비중이 0.6~0.8인 경우에 대해 1번 판단할 것',
  '현금 보유 비중이 0.8~1인 경우에 대해 1번 판단할 것',
  '총 5번 판단할 것',
  ...
  '반드시 소문에 매수하고 뉴스에 매도할 것',
  '반드시 공포에 매수하고 환희에 매도할 것',
  'reflection은 prevInferences가 제시된 경우 이를 복기하여 서술할 것',
  'reason 및 reflection은 다섯 문장 이상 서술할 것',
];

export const INFERENCE_TECH_INDICATOR = [
  'MACD(12, 26, 9)',
  'RSI(14)',
  '볼린저밴드(20, 2)',
  '일목균형표',
