...
import { TradeCostCalibrationSnapshot } from '@/modules/trade/entities/trade-cost-calibration-snapshot.entity';
...
export class AllocationRecommendationSeeder implements Seeder {
  ...
  public async run(): Promise<void> {
    ...
    for (let i = 0; i < 11; i++) {
      ...
      const majorDecisionConfidence = Number((0.84 - (i % 5) * 0.05).toFixed(4));
      const majorExpectedVolatilityPct = Number((0.019 + (i % 4) * 0.0045).toFixed(4));
      const majorExpectedEdgeRate = Number((0.021 - (i % 4) * 0.004).toFixed(6));
      const majorEstimatedCostRate = Number((0.0011 + (i % 3) * 0.0003).toFixed(6));
      const majorSpreadRate = Number((0.00035 + (i % 3) * 0.00008).toFixed(6));
      const majorImpactRate = Number((0.00028 + (i % 3) * 0.00007).toFixed(6));
      const minorDecisionConfidence = Number((0.52 - (i % 4) * 0.06).toFixed(4));
      const minorExpectedVolatilityPct = Number((0.032 + (i % 5) * 0.0055).toFixed(4));
      const minorExpectedEdgeRate = Number((-0.009 - (i % 3) * 0.004).toFixed(6));
      const minorEstimatedCostRate = Number((0.0025 + (i % 4) * 0.0004).toFixed(6));
      const minorSpreadRate = Number((0.0009 + (i % 3) * 0.00012).toFixed(6));
      const minorImpactRate = Number((0.001 + (i % 3) * 0.00018).toFixed(6));
      const nasdaqDecisionConfidence = Number((0.47 + (i % 3) * 0.03).toFixed(4));
      const nasdaqExpectedVolatilityPct = Number((0.012 + (i % 4) * 0.0025).toFixed(4));
      const nasdaqExpectedEdgeRate = Number((-0.002 + (i % 4) * 0.0015).toFixed(6));
      const nasdaqEstimatedCostRate = Number((0.0009 + (i % 3) * 0.00012).toFixed(6));
      const nasdaqSpreadRate = Number((0.0003 + (i % 2) * 0.00006).toFixed(6));
      const nasdaqImpactRate = Number((0.00024 + (i % 2) * 0.00005).toFixed(6));
      ...
      await AllocationRecommendation.save([
        {
          ...
          symbol: 'BTC/KRW',
          decisionConfidence: majorDecisionConfidence,
          expectedVolatilityPct: majorExpectedVolatilityPct,
          riskFlags: ['macro', i % 2 === 0 ? 'btc-dominance-high' : 'liquidity-thin'],
          expectedEdgeRate: majorExpectedEdgeRate,
          estimatedCostRate: majorEstimatedCostRate,
          spreadRate: majorSpreadRate,
          impactRate: majorImpactRate,
          ...regime,
        },
        {
          id: generateMonotonicUlid(),
          ...
          symbol: 'XRP/KRW',
          decisionConfidence: minorDecisionConfidence,
          expectedVolatilityPct: minorExpectedVolatilityPct,
          riskFlags: ['event-risk', i % 2 === 0 ? 'regulatory' : 'headline'],
          expectedEdgeRate: minorExpectedEdgeRate,
          estimatedCostRate: minorEstimatedCostRate,
          spreadRate: minorSpreadRate,
          impactRate: minorImpactRate,
          ...regime,
        },
        {
          id: generateMonotonicUlid(),
          ...
          symbol: 'AAPL',
          decisionConfidence: nasdaqDecisionConfidence,
          expectedVolatilityPct: nasdaqExpectedVolatilityPct,
          riskFlags: i % 3 === 0 ? ['earnings-window'] : ['macro'],
          expectedEdgeRate: nasdaqExpectedEdgeRate,
          estimatedCostRate: nasdaqEstimatedCostRate,
          spreadRate: nasdaqSpreadRate,
          impactRate: nasdaqImpactRate,
          ...regime,
        },
      ]);
    }
...
export class TradeSeeder implements Seeder {
  ...
  async run(): Promise<void> {
    ...
    const user = users[0];
    if (!user || inferences.length < 1) {
      return;
    }

    const infer = (index: number): AllocationRecommendation => inferences[index % inferences.length];
    ...
    await Trade.save([
      {
        ...
        amount: 1_400_000,
        profit: 116_000,
        requestPrice: 96_400_000,
        averagePrice: 96_420_000,
        requestedAmount: 0.01452,
        filledAmount: 0.01452,
        expectedEdgeRate: 0.021,
        estimatedCostRate: 0.0012,
        spreadRate: 0.00042,
        impactRate: 0.00037,
        missedOpportunityCost: null,
        decisionContextVersion: 1,
        decisionPortfolioValue: 10_000_000,
        decisionSymbolNotional: 1_200_000,
        decisionRequestedTradeNotional: 1_450_000,
        decisionCappedTradeNotional: 1_400_000,
        decisionExpectedNetEdgeRate: 0.0198,
        decisionPositionClass: 'existing',
        decisionRegimeSource: 'live',
        decisionExecutionUrgency: 'normal',
        realizedCostRate: 0.00071,
        costCalibrationCoefficient: 0.5917,
      ...
      },
      {
        ...
        amount: 900_000,
        profit: -43_000,
        requestPrice: 97_000_000,
        averagePrice: 96_910_000,
        requestedAmount: 0.00928,
        filledAmount: 0.00761,
        expectedEdgeRate: -0.0043,
        estimatedCostRate: 0.0014,
        spreadRate: 0.00054,
        impactRate: 0.00049,
        missedOpportunityCost: 8_300,
        decisionContextVersion: 1,
        decisionPortfolioValue: 10_000_000,
        decisionSymbolNotional: 1_050_000,
        decisionRequestedTradeNotional: 928_000,
        decisionCappedTradeNotional: 928_000,
        decisionExpectedNetEdgeRate: -0.0057,
        decisionPositionClass: 'existing',
        decisionRegimeSource: 'live',
        decisionExecutionUrgency: 'urgent',
        realizedCostRate: 0.00057,
        costCalibrationCoefficient: null,
        triggerReason: 'risk-reduce',
        gateBypassedReason: 'latency',
        inference: infer(1),
      },
      {
        id: generateMonotonicUlid(),
        ...
        amount: 800_000,
        profit: 58_000,
        requestPrice: 2_850_000,
        averagePrice: 2_847_000,
        requestedAmount: 0.2807,
        filledAmount: 0.2807,
        expectedEdgeRate: 0.0168,
        estimatedCostRate: 0.0011,
        spreadRate: 0.00033,
        impactRate: 0.00029,
        missedOpportunityCost: null,
        decisionContextVersion: 1,
        decisionPortfolioValue: 10_000_000,
        decisionSymbolNotional: 500_000,
        decisionRequestedTradeNotional: 800_000,
        decisionCappedTradeNotional: 800_000,
        decisionExpectedNetEdgeRate: 0.0157,
        decisionPositionClass: 'existing',
        decisionRegimeSource: 'live',
        decisionExecutionUrgency: 'normal',
        realizedCostRate: 0.00035,
        costCalibrationCoefficient: 0.3182,
        triggerReason: 'trend-follow',
        gateBypassedReason: null,
        inference: infer(2),
      },
      {
        ...
        amount: 520_000,
        profit: -21_000,
        requestPrice: 123_100,
        averagePrice: 123_560,
        requestedAmount: 4.223,
        filledAmount: 1.478,
        expectedEdgeRate: -0.0062,
        estimatedCostRate: 0.0025,
        spreadRate: 0.00093,
        impactRate: 0.00112,
        missedOpportunityCost: 6_700,
        decisionContextVersion: 1,
        decisionPortfolioValue: 10_000_000,
        decisionSymbolNotional: 0,
        decisionRequestedTradeNotional: 520_000,
        decisionCappedTradeNotional: 520_000,
        decisionExpectedNetEdgeRate: -0.0087,
        decisionPositionClass: 'new',
        decisionRegimeSource: 'live',
        decisionExecutionUrgency: 'normal',
        realizedCostRate: 0.00424,
        costCalibrationCoefficient: 1.696,
        triggerReason: 'breakout-fail',
        gateBypassedReason: 'volatility',
        inference: infer(3),
      },
      {
        id: generateMonotonicUlid(),
        ...
        requestPrice: 890,
        averagePrice: 892,
        requestedAmount: 415.73,
        filledAmount: 415.73,
        expectedEdgeRate: 0.0081,
        estimatedCostRate: 0.0019,
        spreadRate: 0.00071,
        impactRate: 0.00086,
        missedOpportunityCost: null,
        decisionContextVersion: 1,
        decisionPortfolioValue: 10_000_000,
        decisionSymbolNotional: 370_000,
        decisionRequestedTradeNotional: 370_000,
        decisionCappedTradeNotional: 370_000,
        decisionExpectedNetEdgeRate: 0.0062,
        decisionPositionClass: 'existing',
        decisionRegimeSource: 'cache_fallback',
        decisionExecutionUrgency: 'normal',
        realizedCostRate: 0.0005,
        costCalibrationCoefficient: null,
        triggerReason: 'profit-take',
        gateBypassedReason: null,
        inference: infer(4),
      },
      {
        ...
        requestPrice: 812,
        averagePrice: 813,
        requestedAmount: 320.2,
        filledAmount: 320.2,
        expectedEdgeRate: -0.0029,
        estimatedCostRate: 0.0021,
        spreadRate: 0.00084,
        impactRate: 0.00097,
        missedOpportunityCost: null,
        decisionContextVersion: 1,
        decisionPortfolioValue: 10_000_000,
        decisionSymbolNotional: 0,
        decisionRequestedTradeNotional: 260_000,
        decisionCappedTradeNotional: 260_000,
        decisionExpectedNetEdgeRate: -0.005,
        decisionPositionClass: 'new',
        decisionRegimeSource: 'unavailable_risk_off',
        decisionExecutionUrgency: 'normal',
        realizedCostRate: 0.00173,
        costCalibrationCoefficient: 0.8238,
        triggerReason: 'mean-revert',
        gateBypassedReason: null,
        inference: infer(5),
      },
      {
        ...
        amount: 1_900_000,
        profit: 67_000,
        requestPrice: 236_500,
        averagePrice: 236_420,
        requestedAmount: 8.03,
        filledAmount: 8.03,
        expectedEdgeRate: 0.0053,
        estimatedCostRate: 0.0009,
        spreadRate: 0.00029,
        impactRate: 0.00026,
        missedOpportunityCost: null,
        decisionContextVersion: 1,
        decisionPortfolioValue: 10_000_000,
        decisionSymbolNotional: 650_000,
        decisionRequestedTradeNotional: 1_900_000,
        decisionCappedTradeNotional: 1_000_000,
        decisionExpectedNetEdgeRate: 0.0044,
        decisionPositionClass: 'existing',
        decisionRegimeSource: 'live',
        decisionExecutionUrgency: 'normal',
        realizedCostRate: 0.00056,
        costCalibrationCoefficient: 0.6222,
        triggerReason: 'macro-rebound',
        gateBypassedReason: null,
        inference: infer(6),
      },
      {
        ...
        amount: 2_300_000,
        profit: -128_000,
        requestPrice: 179_000,
        averagePrice: 178_910,
        requestedAmount: 12.85,
        filledAmount: 12.85,
        expectedEdgeRate: -0.0074,
        ...
        decisionContextVersion: 1,
        decisionPortfolioValue: 10_000_000,
        decisionSymbolNotional: 2_300_000,
        decisionRequestedTradeNotional: 2_300_000,
        decisionCappedTradeNotional: 2_300_000,
        decisionExpectedNetEdgeRate: -0.0084,
        decisionPositionClass: 'existing',
        decisionRegimeSource: 'cache_fallback',
        decisionExecutionUrgency: 'urgent',
        realizedCostRate: 0.0005,
...
export class TradeCostCalibrationSnapshotSeeder implements Seeder {
  /**
   * Runs workflow logic in the backend service workflow.
   */
  async run(): Promise<void> {
    await TradeCostCalibrationSnapshot.createQueryBuilder().delete().execute();

    await TradeCostCalibrationSnapshot.save([
      {
        id: generateMonotonicUlid(),
        version: 1,
        category: Category.COIN_MAJOR,
        ...
        windowEnd: new Date(),
        lastTradeAt: new Date(Date.now() - 2 * 60 * 60 * 1000),
        rawMultiplier: 1.18,
        appliedMultiplier: 1.18,
        clampApplied: false,
        status: 'active',
      },
      {
        ...
        windowStart: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000),
        windowEnd: new Date(),
        lastTradeAt: new Date(Date.now() - 6 * 60 * 60 * 1000),
        rawMultiplier: 1.43,
        appliedMultiplier: 1.43,
        clampApplied: false,
        status: 'warmup',
      },
      {
        ...
        costTier: 'medium',
        positionClass: 'existing',
        regimeSource: 'unavailable_risk_off',
        sampleSize: 24,
        windowStart: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000),
        windowEnd: new Date(),
        lastTradeAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000),
        rawMultiplier: 1.62,
...
export const seeders = [
  ...
  TradeSeeder,
  TradeCostCalibrationSnapshotSeeder,
  NotifySeeder,
  HoldingLedgerSeeder,
];
