...
const ProductRevenue = () => {
  ...
  return (
    <>
      <div className='rounded-xl dark:shadow-dark-md shadow-md bg-white dark:bg-dark pt-6 px-0 relative w-full break-words'>
        <div className='px-6'>
                  ...
                  <Table.Row key={index}>
                    <Table.Cell className='whitespace-nowrap ps-6'>
                      <div className='flex gap-3 items-center'>
                        <Image src={item.img} alt='icon' className='h-[60px] w-[60px] rounded-md' />
                    ...
                    <Table.Cell>
                      <Badge className={`${item.statusbg} ${item.statuscolor} `}>{item.statustext}</Badge>
                    </Table.Cell>
                    <Table.Cell>
                      <h4>$3.5k</h4>
                    </Table.Cell>
