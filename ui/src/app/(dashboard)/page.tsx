  ...
  return (
    <>
      <div className='grid grid-cols-12 gap-4 lg:gap-30'>
        <div className='lg:col-span-4 col-span-12 rounded-xl dark:shadow-dark-md shadow-md bg-white dark:bg-dark p-6 relative w-full break-words'>
          <h5 className='card-title text-dark dark:text-white'>{t('trade.profit')}</h5>
          <TradeProfit />
        </div>
        <div className='lg:col-span-8 col-span-12 rounded-xl dark:shadow-dark-md shadow-md bg-white dark:bg-dark pt-6 px-0 relative w-full min-h-full break-words'>
          <div className='px-6'>
        ...
        <div className='lg:col-span-4 col-span-12 rounded-xl dark:shadow-dark-md shadow-md bg-white dark:bg-dark p-6 relative w-full min-h-full break-words'>
