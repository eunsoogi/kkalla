  ...
  return (
    <div className='rounded-xl dark:shadow-dark-md shadow-md bg-white dark:bg-darkgray p-6 relative w-full break-words'>
      <div className='flex justify-between items-center'>
        ...
        <Select id='periods' className='select-md' value={selectedPeriod} onChange={handleSelectChange} required>
      ...
      <div className='-ms-4 -me-3 mt-2'>
        <Chart options={optionsBarChart} series={barChartData.series} type='bar' height='315px' width='100%' />
      </div>
    </div>
  )
}
